          ...
          {active && (
            <ClickOut onClickOut={() => setActive(false)}>
              <div className="absolute text-right  py-2 px-3 bg-white dark:bg-slate-900 shadow-md shadow-gray-300 dark:shadow-gray-900 right-0 rounded-sm border border-gray-100 dark:border-gray-800 w-52">
                <a href="" className="text-sm md:text-md flex gap-1 md:gap-4 py-3 my-2 hover:bg-blue-500 hover:bg-opacity-20 -mx-4 px-6 md:px-4 hover:my-2 rounded-md transition-all hover:scale-110 hover:shadow-md hover:shadow-gray-300 hover:dark:shadow-gray-900">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
